...
const StyledAddBtn = styled.button`
   ...
   padding: ${({isCheckout}) => isCheckout ? '15px 60px' : '15px 30px'};
   font-weight: bold;
   position: relative;
   ...
   svg{
      opacity: 0;
      right: ${({isCheckout}) => isCheckout ? '35px' : '15px'};
      position: absolute;
   ...
   &:hover{
      ...
      padding: ${({isCheckout}) => isCheckout ? '15px 80px 15px 60px' : '15px 50px 15px 30px'};
   }

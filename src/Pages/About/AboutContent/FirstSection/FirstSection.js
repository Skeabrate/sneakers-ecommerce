...
const FirstSection = () => {
	...
	useEffect(() => {
		...
		if (!mediaQuery.matches) {
			...
			gsap.fromTo(
				[leftOrnUpRef.current, leftOrnDownRef.current],
				{
					x: '0',
					y: '0',
				},
			...
			gsap.fromTo(
				[rightOrnUpRef.current, rightOrnDownRef.current],
				{
					x: '0',
					y: '0',
				},
	...
	return (
		<Wrapper>
			<header>
				<StyledTitle>About our company</StyledTitle>
			</header>
			...
			<StyledContentWrapper>
				<StyledArticle ref={contentRef}>
					...
					<p>
						...
						officiis? Earum, qui. Unde error, accusamus quisquam similique
						magnam tempora dolorem.
					</p>

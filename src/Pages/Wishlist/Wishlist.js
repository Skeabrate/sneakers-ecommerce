			...
			<article>
				<StyledContent ref={contentRef}>
					{length ? (
						...
						<StyledError>
							There are no products in your wishlist yet. Start buying and add
							what you like to your wish list.
						</StyledError>
					)}
					...
					{!isAuthenticated && (
						<StyledLoginWrapper length={length}>
							...
							<StyledLoginContent>
								<div>
									<p>
										Join the Sneakers Club today and get 15% off your first
										order. Or log in to save your wish list.
									</p>
									<StyledLink
										as="button"

...
const ContactForm = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if(rules) {
            ...
            if (!state.email.value) reducerActionHandler("setIsActive", "email", true)
    ...
    return (
        <form onSubmit={(e) => handleSubmit(e)}>
            <CustomInput
                ...
                setActiveError={() => !state.name.isActive && reducerActionHandler("setIsActive", "name", true)}
            ...
            <CustomInput
                ...
                setActiveError={() => !state.email.isActive && reducerActionHandler("setIsActive", "email", true)}
            ...
            <StyledTextareaWrapper>
                ...
                <StyledTextarea
                    ...
                    activeError={state.message.isActive && (state.message.isInvalid || !state.message.value)}
                    maxLength="1000"
                    ...
                    <>
                        {state.message.isInvalid || !state.message.value ? (
                            <>
                                ...
                                <StyledError>
                                    {state.message.value ? state.message.isInvalid : `Message is required`}
                                </StyledError>
                            </>

						...
						<StyledAccountDetails>
							...
							<StyledProfileInfo>
								<div style={{ marginTop: '40px' }}>
									...
									<StyledOption>
										User ID : <StyledSpan>{isAuthenticated.token}</StyledSpan>
									</StyledOption>
									<StyledOption>
										Email : <StyledSpan>{isAuthenticated.email}</StyledSpan>
									</StyledOption>
									<StyledOption>
										Phone Number : <StyledSpan>+48 123 456 789</StyledSpan>
									</StyledOption>
								</div>
								...
								<div style={{ marginBlock: '40px' }}>
									...
									<StyledOption>
										Country : <StyledSpan>United States</StyledSpan>
									</StyledOption>
									<StyledOption>
										Region / State : <StyledSpan>California</StyledSpan>
									</StyledOption>
									<StyledOption>
										Street : <StyledSpan>RandomStreet 1234</StyledSpan>
									</StyledOption>
									<StyledOption>
										City : <StyledSpan>Anytown</StyledSpan>
									</StyledOption>
									<StyledOption>
										ZIP / Postal Code : <StyledSpan>34-563</StyledSpan>
									</StyledOption>

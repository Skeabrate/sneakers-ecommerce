...
import { StylledButton, Wrapper, StyledContent } from './ProfileImage.styles';
	...
	return (
		<Wrapper>
			...
			<StyledContent>
				...
				<StylledButton
					onClick={imgPrewievHandler}
					image={isAuthenticated.image || previewUrl}
				>
					<img
						alt={
							isAuthenticated.image || previewUrl ? isAuthenticated.email : ''
						}

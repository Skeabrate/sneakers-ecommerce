		...
		<Wrapper ref={wrapperRef} isHigh>
			...
			<StyledContent count={4} isHigh>
				<div>
					...
					<p>
						Precisely-coded performance zones combine our best stability, best
						comfort and best absorption so you can conquer the unpredictable
						city streets.
					</p>
				</div>
				...
				<div>
					...
					<p>
						Precision-made, seamless zones combine strength and performance with
						smooth comfort to ensure distraction-free movement.
					</p>
				</div>
				...
				<div>
					...
					<p>
						Continental™ Rubber outsole provides extraordinary traction in wet
						and dry conditions.
					</p>
				</div>
			</StyledContent>

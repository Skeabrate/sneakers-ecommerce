...
import { StyledList, StyledListItem, StyledClubImg } from './Login.styles';
			...
			<div>
				...
				<StyledList>
					...
					<StyledListItem>
						...
						Consectetur ipsum dolor sit amet, lorem adipiscing
					</StyledListItem>
					<StyledListItem>
						<svg
							xmlns="http://www.w3.org/2000/svg"
						...
						Adipiscing ipsum dolor sit amet, consectetur lorem
					</StyledListItem>
					<StyledListItem>
						<svg
							xmlns="http://www.w3.org/2000/svg"
						...
						Amet ipsum dolor sit lorem, consectetur adipiscing
					</StyledListItem>
				</StyledList>

				<p>
					Join now and start earning points to access new levels and rewards.
					It's time to unlock the best of sneakers.
				</p>
			</div>

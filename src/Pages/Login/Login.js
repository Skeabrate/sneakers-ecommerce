...
const Login = () => {
	...
	const { setIsRegisterOpen, isInfoOpen, setIsInfoOpen } =
	...
	return (
		<Wrapper>
			<Helmet title="Sneakers Journey - Login" />
					...
					>
						{({ errors, touched, values }) => (
							<StyledForm>
								...
								<StyledSocialButton onClick={(e) => e.preventDefault()}>
									Facebook
									<svg
										xmlns="http://www.w3.org/2000/svg"
										width="24"
			...
			<article>
				<StyledRegister>
					<StyledRegisterTitle>
						JOIN OUR SNEAKERS CLUB & GET 10% OFF
					</StyledRegisterTitle>
					<StyledLink as="button" onClick={() => setIsRegisterOpen(true)}>
						Register
					</StyledLink>
				</StyledRegister>
			</article>

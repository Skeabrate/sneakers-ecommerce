...
const AmountInput = ({ label, item = false, inputValue, setInputValue = () => {}, showDelete = false }) => {
    ...
    return (
        <div>
            ...
            <Wrapper label={label}>
                <StyledPlusMinusBtn aria-label="decrease amount of products" onClick={minusHandler}>
